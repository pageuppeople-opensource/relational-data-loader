...
psql -U postgres -d relational_data_loader_integration_tests -a -f .\integration_tests\csv_source\assertions\column_test_full_refresh_assertions.sql
echo psql-ErrorLevel %errorlevel%
if %errorlevel% neq 0 exit /b %errorlevel%
